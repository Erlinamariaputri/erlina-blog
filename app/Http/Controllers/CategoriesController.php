...
class CategoriesController extends Controller
{
    ...
    public function delete($id)
    {
        ...
        if ($data == null) {
            return redirect('admin/Categories')->with('status', 'Data tidak ditemukan !');
        }
        ...
        $delete = $data->delete();
        if ($delete) {
            return redirect('admin/Categories')->with('status', 'Berhasil hapus category !');
        }
        return redirect('admin/Categories')->with('status', 'Gagal hapus category !');
    }
